...
urlpatterns = [
    ...
    path('configuracion/secuencias/', views.configurar_secuencias_view, name='configurar_secuencias'),
    ...
    path('configuracion/plantillas/<int:plantilla_id>/', views.detalle_plantilla_view, name='detalle_plantilla'),
    path('configuracion/plantillas/<int:plantilla_id>/preview/', views.preview_plantilla_view, name='preview_plantilla'),
    path('configuracion/plantillas/<int:plantilla_id>/activar/', views.activar_plantilla_view, name='activar_plantilla'),
    path('configuracion/plantillas/<int:plantilla_id>/desactivar/', views.desactivar_plantilla_view, name='desactivar_plantilla'),
    path('configuracion/plantillas/<int:plantilla_id>/eliminar/', views.eliminar_plantilla_view, name='eliminar_plantilla'),
